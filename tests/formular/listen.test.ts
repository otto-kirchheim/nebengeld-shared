...
import { listenBelegung, listenBeschriftung, listenWert, loeseListenAuf, schluesselAufPlatz } from '../../src/formular/listen';
import type { ListenGruppe, TabellenDef, Zeile } from '../../src/formular/types';
